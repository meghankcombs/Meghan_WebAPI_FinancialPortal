...
namespace Meghan_CF_FinancialPortal.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            Household household = db.Households.Find(id); //show their household data (control this in view)
            if (household == null)
            {
                return HttpNotFound();
            }
        ...
        {
            if ((DateTime.Now - db.Invites.FirstOrDefault(i => i.HHToken == code).InviteDate).TotalDays < 6) //if invite newer than 6 days
            {
